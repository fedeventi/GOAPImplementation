...
public class HeavyPathFindingState<T> : State<T>
{
    float speed;
    Enemy _enemy;
    ...
    public HeavyPathFindingState(Enemy enemy, Transform player, float distancetoAttack)
    {
        _enemy = enemy;
        _player = player;
    ...
    {
        base.OnUpdate();
        if (_enemy.InSight()) _enemy.TransitionSt("Throw");
